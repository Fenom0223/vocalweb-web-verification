export const translations = {
  ...
  es: {
    ...
    terms: {
      ...
      effectiveDate: "Fecha de entrada en vigor: 19 de julio de 2025",
      intro: "Bienvenido a VocalWeb solutions. Estos términos y condiciones ('Términos') rigen el uso de los servicios de automatización de IA y agentes de voz ('Servicios') proporcionados by VocalWeb solutions ('nosotros', 'nuestro', '[SU NOMBRE LEGAL O EMPRESA REGISTRADA]'). Al acceder y utilizar nuestros servicios, usted acepta cumplir y estar sujeto a estos términos.",
