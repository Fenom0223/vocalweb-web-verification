...
export const translations = {
  en: {
    ...
    privacyPolicy: {
      ...
      sharingTitle: "With whom we share your Google user data:",
      sharingIntro: "Vocalweb does not share, sell, rent, or disclose your Google user data obtained through APIs with third parties, except in the following limited circumstances:",
      sharingPoint1: "With service providers acting on our behalf: We may use third parties to help us operate our service (e.g., hosting, analytics, technological infrastructure). These third parties are subject to strict confidentiality obligations and only access the necessary information to perform their functions on our behalf, under our instructions.",
      sharingPoint2: "To comply with law or protect rights: If required by law, or if we believe in good faith that it is necessary to protect our rights, property, or safety, or those of our users or the public.",
      sharingPoint3: "With your explicit consent: With your prior and explicit consent, we may share your information with third parties for specific purposes that will be clearly communicated to you.",
    ...
    refundPolicy: {
      ...
      exception1: "If Vocalweb solutions is unable to provide the contracted service due to reasons directly attributable to us (e.g., critical and unexplained failures in our platform that prevent the main functioning of the service for an extended period and are not resolved in a reasonable time), and not due to external factors beyond our control (e.g., customer connectivity issues, incorrect configurations by the customer or third-party services, changes in third-party API policies).",
      exception2: "In cases of clear and verifiable billing errors on our part.",
      exceptionsOutro: "To request a refund in an exceptional case, you must contact us within 14 days of the incident or charge that justifies the request, providing a detailed explanation and any relevant evidence. We reserve the right to investigate and determine the validity of the request.",
      processTitle: "Refund request process",
      processText: "All refund requests must be submitted in writing to our support email: admin@vocalweb.club. Include your company name, the date of purchase, and a detailed description of the reason for your request. We will evaluate each request individually and respond to you within a reasonable time.",
      modificationsTitle: "Modifications to the refund policy",
      modificationsText: "We reserve the right to modify this refund policy at any time. Modifications will become effective once published on our website. We recommend that you review this policy periodically.",
      contactTitle: "Contact",
  ...
  es: {
    ...
    privacyPolicy: {
      ...
      apiDataIntro: "Nuestros servicios están diseñados para interactuar con sus aplicaciones y datos existentes, como Google Workspace. Para hacer esto, necesitamos acceder a ciertos datos en su nombre, siempre con su consentimiento explícito.",
      sheetsTitle: "Datos de archivos de Google Drive (https://www.googleapis.com/auth/drive.file):",
      sheetsText: "Propósito: Usamos este permiso para interactuar con archivos de hojas de cálculo específicos que usted selecciona explícitamente a través de la interfaz oficial de Google Picker. Esto nos permite registrar automáticamente los detalles de las citas (como fecha, nombre del paciente, estado y grabaciones de llamadas) en su hoja de registro designada. Importante: solo accedemos a los archivos que usted elige directamente a través de Google Picker. No accedemos a otros archivos en su Google Drive sin su selección específica.",
      calendarTitle: "Datos de Google Calendar (https://www.googleapis.com/auth/calendar):",
      calendarText: "Propósito: Accedemos a su calendario para detectar nuevas citas, modificar los títulos de los eventos (por ejemplo, agregando un emoji '✅ Confirmado' o '❌ Cancelado'), programar citas o enviar recordatorios, según lo defina su automatización.",
      ...
      sharingTitle: "Con quién compartimos sus datos de usuario de Google:",
      sharingIntro: "Vocalweb no comparte, vende, alquila ni divulga sus datos de usuario de Google obtenidos a través de API con terceros, excepto en las siguientes circunstancias limitadas:",
      sharingPoint1: "Con proveedores de servicios que actúan en nuestro nombre: podemos utilizar a terceros para que nos ayuden a operar nuestro servicio (por ejemplo, alojamiento, análisis, infraestructura tecnológica). estos terceros están sujetos a estrictas obligaciones de confidencialidad y solo acceden a la información necesaria para realizar sus funciones en nuestro nombre, bajo nuestras instrucciones.",
      sharingPoint2: "Para cumplir con la ley o proteger derechos: si lo exige la ley, o si creemos de buena fe que es necesario para proteger nuestros derechos, propiedad o seguridad, o los de nuestros usuarios o el público.",
      sharingPoint3: "Con su consentimiento explícito: con su consentimiento previo y explícito, podemos compartir su información con terceros para fines específicos que se le comunicarán claramente.",
